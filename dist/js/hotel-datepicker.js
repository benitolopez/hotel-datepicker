/*! hotel-datepicker 2.0.0 - Copyright 2017 Benito Lopez (http://lopezb.com) - https://github.com/benitolopez/hotel-datepicker - MIT */
...
HotelDatepicker.prototype.addListeners = function addListeners () {
	...
	window.addEventListener('resize', function (evt) { return this$1.closeDatepicker(evt); });
...
HotelDatepicker.prototype.createMonthDomString = function createMonthDomString (_date) {
	...
	for (var week = 0; week < 6; week++) {
		...
		for (var i$2 = 0; i$2 < 7; i$2++) {
			...
			var dayAttributes = {
				time: _day$2.time,
				class: 'datepicker__month-day--' + _day$2.type + ' datepicker__month-day--' + (_day$2.valid ? 'valid' : 'invalid') + ' ' + (isToday ? 'datepicker__month-day--today' : '') + ' ' + (isDisabled ? 'datepicker__month-day--disabled' : '')
			};
